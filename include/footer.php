    <footer class="footer bg-dark text-light">
      ...
      <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
          <p class="col-md-5 mb-0 text-white d-flex justify-content-start">© 2022 Company, Inc</p>
          ...
          <a href="/" class="col-md-2 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
            <svg width="95" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 319.24 146.48" style="enable-background:new 0 0 319.24 146.48;" xml:space="preserve">
              <style type="text/css">
          ...
          <ul class="nav col-md-5 justify-content-end">
            <li class="nav-item"><a href="/home.php" class="nav-link px-2 text-white">الرئيسية</a></li>
            <li class="nav-item"><a href="/lectures.php" class="nav-link px-2 text-white">الدروس</a></li>
            <li class="nav-item"><a href="/sd-plan.php" class="nav-link px-2 text-white">جدول الماسية</a></li>
            <li class="nav-item"><a href="/dayle-tasks.php" class="nav-link px-2 text-white">المهام اليومية</a></li>
            <li class="nav-item"><a href="/products.php" class="nav-link px-2 text-white">المنتجات</a></li>
          </ul>
        </footer>
      </div>
    </footer>
